...
def index():
    ...
    return render_template('home.html', title = title, pitch = pitch, pickuplines=pickuplines, motivationpitch= motivationpitch, inspirationpitch = inspirationpitch, funnypitch = funnypitch, upvotes=upvotes)
